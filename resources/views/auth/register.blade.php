            ...
            <form action="{{ url('/registro') }}" method="POST" >
                ...
                <div class="flex justify-center align-middle">
                    <div class="border-2 rounded-sm shadow-sm p-5 w-4/12">
                        <h2 class="text-gray-700 text-3xl text-center my-2 font-bold uppercase">Registrar Nuevo usuario</h2>
                        <div class="flex flex-col mt-5">
                            <label for="name" class="text-gray-700 font-bold uppercase">Nombre</label>
                            <input type="text" name="name" id="name" class="w-full border rounded-sm h-10 mb-2 p-2" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <button type="submit" class="block p-3 rounded-sm bg-gray-600 text-white w-full my-5 font-bold uppercase">Registrar</button>
                    </div>
                </div>
            </form>
        </div>
